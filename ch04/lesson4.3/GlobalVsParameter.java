public class GlobalVsParameter {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("초기 잔액: " + globalBalance);

        depositGlobal(500);
        withdrawGlobal(200);
        System.out.println("최종 잔액: " + globalBalance);
    ...
    static void demonstrateSideEffects() {
        System.out.println("전역 변수의 부작용 시연: ");
        System.out.println("현재 전역 잔액: " + globalBalance);

        someComplexOperation();
        System.out.println("작업 후 전역 잔액: " + globalBalance);

        if (globalBalance != 1300) {
