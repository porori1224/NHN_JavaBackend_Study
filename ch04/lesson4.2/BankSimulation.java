public class BankSimulation {
    ...
    static double balance, totalDeposits, totalWithdrawals;
    ...
    public static void deposit(double amount) {
        ...
        System.out.println((int)amount + "원이 입금되었습니다.");
        checkBalance();
    }
    ...
    public static void showStatistics() {
        ...
        System.out.println("\n=== 거래 통계 ===");
        System.out.println("총 거래 횟수: " + transactions);
        System.out.println("총 입금액: " + (int)totalDeposits + "원");
        System.out.println("총 출금액: " +  (int)totalWithdrawals + "원");
        System.out.println("현재 잔액: " + (int)balance + "원");

        if (transactions > 0) {
            System.out.println("평균 거래액: " + (int)(totalDeposits + totalWithdrawals) / transactions + "원");
        }
    }
}