...
public class EmployeeManagementSystem {
    ...
    public void displaySalaryReport() {
        ...
        for (Employee employee : employees.values()) {
            System.out.printf("%s (%s): %.1f원%n", employee.name, employee.getPosition(), employee.calculateMonthlySalary());
        }
        System.out.printf("전체 월 금어 총액: %.1f원%n", calculateTotalMonthlySalary());
    }
}
