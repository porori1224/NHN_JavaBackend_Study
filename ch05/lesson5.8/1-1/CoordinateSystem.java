...
class CoordinateTest {
    public static void main(String[] args) {
        ...
        System.out.printf("원점에서 P1까지의 거리: %.1f%n", p1.distanceFromOrigin());
        System.out.printf("P1에서 P2까지의 거리: %.1f%n%n", p1.distanceTo(p2));
        ...
        System.out.printf("XY 평면 투영: %.2f%n", p3d1.distanceFromOrigin());

        // TODO 18: 선분 생성하고 정보 출력하기
        // p3d1에서 p3d2로의 선분
        // 길이와 중점 출력
        CoordinateSystem.LineSegment seg = new CoordinateSystem.LineSegment(p3d1, p3d2);
        System.out.println("\n선분: ");
        System.out.printf("길이: " + seg.getLength());
        System.out.println("\n중점: " + seg.getMidpoint());
    }
}
