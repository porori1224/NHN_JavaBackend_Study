...
public class BookLibrary {
    static class Book {
        ...
        public String toString() {
            return (title + " - " + author + " (" + year + ") " + (int)price + "원");
        }
    ...
    public static void main(String[] args) {
        ...
        for (Book book : library) {
            if (book.author.equals("남궁성")) System.out.println(book);
        }

        // TODO: 30000원 이상의 책을 찾아서 출력하세요
        System.out.println("\n=== 30000원 이상의 책 ===");
        for  (Book book : library) {
            if (book.price >= 30000) System.out.println(book);
        }

        // TODO: 2020년 이후 출간 도서를 찾아서 출력하세요
        System.out.println("\n=== 2020년 이후 출간 도서 ===");
        for (Book book : library) {
            if (book.year >= 2020) System.out.println(book);
        }
